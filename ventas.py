...
def abrir_ventas():
    ...
    for texto, fila, col in campos:
        tk.Label(ventas, text=texto, bg="#008CFF").grid(row=fila, column=col, padx=10, pady=5, sticky="w")
        entrada = tk.Entry(ventas, bg="#000000", fg="#FFFFFF")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
    ...
    for i, (texto, cmd) in enumerate(botones):
        tk.Button(ventas, text=texto, width=10, command=cmd, bg="#000000", fg="#00FF9D").grid(row=6, column=i, padx=9, pady=9)  
    ...
    tk.Button(ventas, text="Regresar al Menú", width=20,
              command=lambda: [ventas.destroy(), menu.abrir_menu()], bg="#000000", fg="#00FF9D").grid(row=8, column=0, columnspan=4, pady=10)  
