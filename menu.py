...
def abrir_menu():
    ...
    menu.configure(bg="#1E3932")  # Color verde oscuro de Starbucks
    ...
    frame = tk.Frame(menu, bg="#FFFFFF", padx=10, pady=10)  # Color blanco para el recuadro
    frame.place(relx=0.5, rely=0.5, anchor="center") 

    tk.Label(frame, text="Starbucks", font=("Algerian", 20, "bold"), bg="#FFFFFF", fg="#1E3932").pack(pady=5)

    tk.Label(frame, text="Bienvenido al Menú Principal", font=("Algerian", 16, "bold"), bg="#FFFFFF", fg="#1E3932").pack(pady=10)
    ...
    for texto, comando in botones:
        tk.Button(frame, text=texto, width=25, height=2, bg="#00704A", fg="#FFFFFF", font=("Algerian", 12), command=comando).pack(pady=5)
